...
import './inventariosMaterialDetalle.css';
...
const InventariosMaterialDetalle = ({ isOpen, onClose, fila }) => {
    ...
    return (
        <div className="inventarioMaterialDetalle">
...
export default InventariosMaterialDetalle;