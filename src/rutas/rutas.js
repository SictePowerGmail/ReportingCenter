...
/* Operacion */
import AtencionAP from "../pages/operacion/Atencion_AP";
        ...
        <>
            <Routes>
                <Route path='/' exact element={<Navbar />} >
                    ...
                    {/* Operacion */}
                    <Route path='/AtencionAP' exacte element={<AtencionAP />} />
                    ...
                    <Route path='/EnelAPSegumiento' exacte element={<EnelAPSegumiento />} />
                    {/* Logistica */}
